...
public class search_Favorite extends JPanel {
	...
	public search_Favorite() {
		...
		JLabel LogoIcon = new JLabel("");
	     ...
	     panel.add(LogoIcon);
	     LogoIcon.setIcon(new ImageIcon(search_Favorite.class.getResource("/images/logo.png")));
		...
		previousIcon.setIcon(new ImageIcon(search_Favorite.class.getResource("/images/previousIcon.png")));
		previousIcon.setBounds(6, 6, 54, 35);
		panel.add(previousIcon);
