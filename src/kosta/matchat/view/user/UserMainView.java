...
public class UserMainView extends JPanel {
	...
	public UserMainView() {
		...
		JButton btnKind = new JButton("음식종류별 검색");
		...
		btnKind.setFont(new Font("나눔고딕코딩", Font.BOLD, 25));
		userMainView.add(btnKind);
		
		JButton btnName = new JButton("맛집 이름 검색");
		...
		btnName.setFont(new Font("나눔고딕코딩", Font.BOLD, 25));
		...
		uFravoriteList.setFont(new Font("나눔고딕코딩", Font.BOLD, 25));
		...
		MemDelete.setFont(new Font("나눔고딕코딩", Font.BOLD, 25));
