	...
	public UserKindSerachView() {
				...
				koBtn.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						removeAll();
						LoginView.contentPane.add("search",new UserKindSearchListView("ÇÑ½Ä"));
						revalidate();
						repaint();
				...
				engBtn.addMouseListener(new MouseAdapter() {
					@Override
					public void mouseClicked(MouseEvent e) {
						LoginView.contentPane.add("search",new UserKindSearchListView("¾ç½Ä"));
						revalidate();
						repaint();
						LoginView.cards.next(LoginView.contentPane);
					}
				...
				japanBtn.addMouseListener(new MouseAdapter() {
					@Override
					public void mouseClicked(MouseEvent e) {
						LoginView.contentPane.add("search",new UserKindSearchListView("ÀÏ½Ä"));
						revalidate();
						repaint();
						LoginView.cards.next(LoginView.contentPane);
					}
				...
				chinaBtn.addMouseListener(new MouseAdapter() {
					@Override
					public void mouseClicked(MouseEvent e) {
						LoginView.contentPane.add("search",new UserKindSearchListView("Áß½Ä"));
						revalidate();
						repaint();
						LoginView.cards.next(LoginView.contentPane);
