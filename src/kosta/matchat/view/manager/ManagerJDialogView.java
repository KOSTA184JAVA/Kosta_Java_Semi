	...
	public ManagerJDialogView(ManagerJTableView managerJTableView2, String string, Restaurant restaurant) {
		...
		if (string.equals("추가")) {
			...
			if (menuList != null) {
				...
				case 1: {
					System.out.println("1111111111111일떄");
				...
				case 2: {
					System.out.println("222222222222일떄");
				...
				case 3: {
					System.out.println("33333333333일떄");
				...
				default: {
					System.out.println("default일떄");

					break;
				}
				}
			} else {
				System.out.println("000000000000000000일떄");
