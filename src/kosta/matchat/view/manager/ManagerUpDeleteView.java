...
public class ManagerUpDeleteView extends JDialog implements ActionListener{
		...
		public ManagerUpDeleteView(ManagerJTableView managerJTableView2, String string) {
			...
			btnUpdate.setFont(new Font("³ª´®°íµñÄÚµù", Font.BOLD, 14));
			...
			btnMenuDelete1.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 7));
			...
			btnMenuDelete2.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 7));
			...
			btnMenuDelete3.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 7));
